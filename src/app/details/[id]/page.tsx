  ...
  return (
    <div className='bg-white text-black'>
      <div className='h-[100vh] grid grid-cols-3 items-center'>
        <div className='grid grid-cols-2 rotateY-3d-left'>
          <div className='text-right mr-[1rem] font-medium'>
            <div>ID</div>
            <div>Height</div>
            <div>Weight</div>
            <div>Abilities</div>
        ...
        <div className='h-[90%] text-center flex flex-col '>
          <h1>{pokemon.name}</h1>
          <img src={pokemon.sprite} alt={pokemon.name} className='m-auto' />
        </div>
        <div className='grid grid-cols-2 rotateY-3d-right'>
          <div className='text-right mr-[1rem] font-medium'>
            <div>HP</div>
            <div>Attack</div>
            <div>Defence</div>
