...
export const Pokemon = TypeCompiler.Compile(T.Object({
  ...
  order: T.Number(),
  species: NameAndUrl,
  sprites: T.Object({ front_default: T.String() }),
  stats: T.Array(T.Object({
    base_stat: T.Number(), effort: T.Number(), stat: T.Object({ name: T.String() }),
  })),
